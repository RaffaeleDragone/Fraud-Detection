...
def comparing_step1_randomforest(df):
...
def comparing_step2_randomforest(df):
...
def comparing_step3_randomforest(df):
...
def comparing_step4_randomforest(df):
...
def comparing_step5_randomforest(df):
    # Step1 : dataFrame con soltanto CASH_OUT e TRASFER
    dataFrameStep4 = util.step_4(df)
...
def random_forest_model(dfX, dfY):
    start_time = time.time()
    X_train, X_test, y_train, y_test = train_test_split(dfX, dfY, test_size=0.2, random_state=42,
                                                        stratify=dfY)
...
comparing_step1_randomforest(dataFrame)
#comparing_step2_randomforest(dataFrame)
#comparing_step3_randomforest(dataFrame)
#comparing_step4_randomforest(dataFrame)
#comparing_step5_randomforest(dataFrame)
